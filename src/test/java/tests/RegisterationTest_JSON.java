...
public class RegisterationTest_JSON extends TestBase {
	...
	public void testRegister() throws InterruptedException, FileNotFoundException, IOException, ParseException
	{
		...
		RegisterationPage1.register(jdr.fname,jdr.lname,jdr.email,jdr.pass,jdr.pass);
	...
	public void userCanLogin() throws InterruptedException
	{
		...
		LoginPage1.login("Test20@gmail.com", "123456");
